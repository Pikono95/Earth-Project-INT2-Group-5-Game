...
def start_mini_game2():
    ...
    class Ball:
        ...
        def reset(self):
            ...
            available = [t for t in TRASH_TYPES if not any(
                b.accepted_type == t and b.is_full()
                for b in self.bins)]
    ...
    while running:
        ...
        if all(b.is_full() for b in bins) and not game_over:
        ...
        screen.blit(
            font.render(f"Trash: {ball.trash_type}", True, (255,255,255)),
            (50,100)
        )
